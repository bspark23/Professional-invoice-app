              ...
              <CardContent className="p-8">
                <div className="flex justify-between items-start mb-8">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-gray-600 dark:text-gray-300">#INV-001</p>
                    <Badge variant="default" className="mt-2 shadow-sm">
                      ✅ Paid
                    </Badge>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-8 mb-8">
                  <div>
                    ...
                    <p className="font-medium text-gray-900 dark:text-white">Acme Corporation</p>
                ...
                <div className="bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-700 dark:to-gray-600 rounded-lg p-6 mb-6">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-xl font-bold text-gray-900 dark:text-white">$2,500.00</span>
                  </div>
                </div>

                <div className="flex justify-between items-center text-2xl font-bold">
                  <span className="text-gray-900 dark:text-white">Total:</span>
                  <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">$2,500.00</span>
                </div>
              </CardContent>
            </Card>
          </div>
